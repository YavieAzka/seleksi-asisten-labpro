...
export class AuthService {
  // Ganti dengan URL Auth Server (jika via Docker localhost, gunakan port 3000)
  private readonly authServerUrl = 'http://localhost:3000';
  private readonly clientId = 'sieks-client'; // Sesuaikan dengan database
  private readonly redirectUri = 'http://localhost:3001/auth/callback';
